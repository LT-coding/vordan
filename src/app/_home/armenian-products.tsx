...
export default function ArmenianProducts() {
  return (
    <section className='mt-44 mx-8 flex flex-col gap-16'>
      <h2 className='text-5xl font-bold'>Հայկական արտադրանք</h2>
      <div className='relative'>
        <div className='absolute top-0 left-0 h-[634px] w-full -z-10'>
          <img
            src='/images/armenian-products/main.png'
            alt='Armenian products'
          />
        </div>
